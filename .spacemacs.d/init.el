...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (undo-tree js2-mode csv-mode which-key hydra sql-indent org-plus-contrib nameless mmm-mode json-mode font-lock+ evil-unimpaired diff-hl counsel-css async aggressive-indent ace-window))))
(custom-set-faces
